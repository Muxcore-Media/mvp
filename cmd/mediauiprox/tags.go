...
func (s *server) handleListTags(w http.ResponseWriter, r *http.Request) {
	...
	defer cancel()
	movieOK, tvOK := false, false
	if media != "tv" && s.movies != nil {
	...
	available := (media == "movie" && movieOK) || (media == "tv" && tvOK) || (media == "all" && (movieOK || tvOK))
