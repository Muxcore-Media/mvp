...
#
# Usage:
#   ./scripts/publish-muxcored-ghcr.sh            # tag = core HEAD describe / v0.5.7 fallback
#   ./scripts/publish-muxcored-ghcr.sh v0.5.7
#   BUILD_ONLY=1 ./scripts/publish-muxcored-ghcr.sh v0.5.7   # local image only (no GHCR login/push)
#   MUXCORE_CORE_DIR=/path/to/core ./scripts/publish-muxcored-ghcr.sh v0.5.7
#
